...
const GARDEN_DATA = {
  ...
  plants: [
    ...
    { id: 'it_04', common_name: 'ต้นคริสติน่า', scientific_name: 'Syzygium australe', images: ["/workpic4.jfif"], location_name: 'สวนพฤกษศาสตร์ ข้างตึกม่วง' },
    { id: 'it_05', common_name: 'ต้นกระบองเพชร', scientific_name: 'Cactaceae', images: ["/workpic5.jfif"], location_name: 'สวนพฤกษศาสตร์ it' },
